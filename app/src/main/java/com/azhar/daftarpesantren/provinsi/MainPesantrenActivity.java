...
public class MainPesantrenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_pesantren);
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MainPesantrenActivity.this, "Ups, tidak ada data!",
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(MainPesantrenActivity.this,
